...
pkgs.python3Packages.buildPythonApplication rec {
  ...
  dependencies = with pkgs.python3Packages; [
    ...
    defusedxml
    dulwich
    gaphas #(import ./gaphas-3.nix {inherit pkgs;})
    generic
    jedi
    pillow
    pycairo
  ...
  postInstall = ''
    ...
    substituteInPlace $out/${pkgs.python3Packages.python.sitePackages}/gaphor/settings.py \
  ...
  meta = {
    ...
    changelog = "https
    #../../modules/nixos/phpmyadmin.nix://github.com/gaphor/gaphor/releases/tag/${version}";
