{
  ...
  in
  {
    nixosModules.modulix-os = import ./modules/nixos/default.nix { inherit self nixpkgs inputs; };

    homeModules = {
      quentin = import ./modules/home-manager/quentin/default.nix { inherit self nixpkgs inputs;};
    };
